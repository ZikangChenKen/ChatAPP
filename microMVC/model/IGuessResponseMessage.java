...
/**
 * The message for response of the guess.
 */
public interface IGuessResponseMessage extends IRoomMessage {
	...
	public static IDataPacketID GetID() {
		return DataPacketIDFactory.Singleton.makeID(IGuessResponseMessage.class);
	}
	...
	public default IDataPacketID getID() {
		return IGuessResponseMessage.GetID();
	}
	 ...
	 * @return
	 */
	public static IGuessResponseMessage make(String msg){
		return new IGuessResponseMessage() {
