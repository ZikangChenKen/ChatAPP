...
/**
 * For micro mvc initialization
 */
public interface IGameInitMsg extends IRoomMessage {
	...
	public static IDataPacketID GetID() {
		return DataPacketIDFactory.Singleton.makeID(IGameInitMsg.class);
	}
	 ...
	 * @return
	 */
	public static IGameInitMsg make(String msg){
