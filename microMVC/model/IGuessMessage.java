...
/**
 * Message for guess action.
 */
public interface IGuessMessage extends IRoomMessage {
	/**
	...
	public static IDataPacketID GetID() {
		return DataPacketIDFactory.Singleton.makeID(IGuessMessage.class);
	}
	 ...
	 * @return
	 */
	public static IGuessMessage make(String msg){
		return new IGuessMessage() {
